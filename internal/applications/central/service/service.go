...
// Register 處理服務註冊
func (h *Service) Register(ctx context.Context, req *centralRPC.RegisterRequest) (*centralRPC.RegisterResponse, error) {
...
// Heartbeat 處理心跳
func (h *Service) Heartbeat(ctx context.Context, req *centralRPC.HeartbeatRequest) (*centralRPC.HeartbeatResponse, error) {
...
// Deregister 處理登出
func (h *Service) Deregister(ctx context.Context, req *centralRPC.DeregisterRequest) (*centralRPC.DeregisterResponse, error) {
...
func (h *Service) Login(ctx context.Context, req *centralRPC.LoginRequest) (*centralRPC.LoginResponse, error) {
...
// GetRoute 取得路由
func (h *Service) GetRoute(ctx context.Context, req *centralRPC.GetRouteRequest) (*centralRPC.GetRouteResponse, error) {
